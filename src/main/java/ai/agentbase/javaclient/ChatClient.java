...
/**
 * This class represents a client for interacting with the AgentBase Chat API.
 * It provides methods for creating, retrieving, and managing chat messages and conversations.
 */
public class ChatClient extends AgentBaseClient {
     ...
     */
    public Response createChatMessage(String inputs, String query, String user, boolean stream, String conversation_id) throws AgentBaseClientException {
     ...
     * @throws AgentBaseClientException If an error occurs while sending the request.
     */
    public Response getConversationMessages(String user, String conversation_id, String first_id, int limit) throws AgentBaseClientException {
     ...
     * @throws AgentBaseClientException If an error occurs while sending the request.
     */
    public Response getConversations(String user, String first_id, int limit, String pinned) throws AgentBaseClientException {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("user", user);
     ...
     * @throws AgentBaseClientException If an error occurs while sending the request.
     */
    public Response renameConversation(String conversation_id, String name, String user) throws AgentBaseClientException {
        JSONObject json = new JSONObject();
        json.put("name", name);
        json.put("user", user);
     ...
     * @throws AgentBaseClientException If an error occurs while sending the request.
     */
    public Response deleteConversation(String conversation_id, String user) throws AgentBaseClientException {
        JSONObject json = new JSONObject();
        json.put("user", user);
